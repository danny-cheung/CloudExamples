...
api_url="https://dns.api.rackspacecloud.com/v1.0"
...
function domain-list()
{
	...
	domains=`curl -s -X GET $api_url/$tenant_id/domains/ -H 'Accept:application/json' -H 'Content-Type: application/json'  -H "X-Auth-Token: $auth_token" | jq '.domains'`
